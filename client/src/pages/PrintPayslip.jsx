...
const PrintPayslip = () => {
  ...
  return (
    <div className='animate-fade-in max-w-2xl mx-auto p-8 bg-white'>
      <div className="text-center border-b border-slate-200 pb-6 mb-8">
        ...
        <p className="text-slate-500 text-sm mt-1">{format(new Date(payslip.year, payslip.month -1), "MMM yyyy")}</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        ...
        <div className="">
          ...
          <p className="font-semibold text-slate-900">{format(new Date(payslip.year, payslip.month -1), "MMM yyyy")}</p>
        </div>
      </div>
      <div className="">
