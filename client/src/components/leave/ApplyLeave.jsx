...
const ApplyLeave = ({open, onClose, onSuccess}) => {
            ...
            <div className="bg-white relative rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in" onClick={(e)=> e.stopPropagation()}>
                ...
                <div className="flex items-center justify-between p-6 pb-0">
                    <div className="">
                        ...
                        <p className='text-sm text-slate-400 mt-0.5'>Submit your leave for approval</p>
                    </div>
                ...
                <form onSubmit={handleSubmit} className='p-6 space-y-5'>
                    {/* leave type */}
                    <div className="">
                        <label htmlFor="" className='flex items-center gap-2 text-sm font-medium text-slate-700 mb-2'>
                            <FileTextIcon className='w-4 h-4 text-slate-400' /> Leave Type
                        </label>
                    ...
                    <div className="">
                        <label htmlFor="" className='text-sm font-medium text-slate-700 mb-2 block'>
                        Reason
                        </label>

                        <textarea name="reason" required role={3} className='resize-none' placeholder='Briefly describe why you need this leave...' />
                    </div>

                    {/* button */}

                    <div className="flex gap-3 pt-2">
                        <button className='btn-secondary flex-1' onClick={onClose} type='button'>Cancel</button>
                        <button className='btn-primary flex-1 flex items-center justify-center gap-2' disabled={loading} onClick={onClose} type='submit'>
