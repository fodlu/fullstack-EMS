	...
	return (
		<form
			...
			<div className='card p-5 sm:p-6'>
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
					<div className=''>
						<label htmlFor='dept' className='block mb-2'>
							Department
						</label>
						<select
							name='department'
							...
							{DEPARTMENTS.map((depName) => (
								<option value={depName} key={depName}>
									{depName}
								</option>
							))}
						</select>
					...
					<div>
						<label className='block mb-2' htmlFor='allowance'>
							Allowances
						</label>
						<input
							type='number'
					...
					<div>
						<label className='block mb-2' htmlFor='deduction'>
							Deductions
						</label>
						<input
							type='number'
			...
			<div className='card p-5 sm:p-6'>
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
					<div className='sm:col-span-2'>
						<label className='block mb-2' htmlFor='workemail'>
							Work Email
						</label>
						<input
							type='email'
					...
					{isEditMode && (
						<div>
							...
							<input
								...
								name='password'
								id='password'
								placeholder='Leave a blank to keep current'
							/>
						</div>
					)}
					<div>
