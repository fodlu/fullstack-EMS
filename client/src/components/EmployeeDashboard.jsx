...
const EmployeeDashboard = ({data}) => {
    ...
    <div className="animate-fade-in">
        <div className="page-header">
            ...
            <p className="page-subtitle">{employee?.position} - {employee?.department || 'No Department'} </p>
        </div>
            ...
            {cards.map((card, index) => (
                <div key={index} className="card card-hover p-5 sm:p-6 relative overflow-hidden group flex items-center justify-between">
                    <div>
                        ...
                        bottom-0 w-1 rounded-r-full bg-slate-500/70 group-hover:bg-indigo-500/70" />
